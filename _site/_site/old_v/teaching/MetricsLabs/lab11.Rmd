...
For more examples of what the `ipumsr` package can do, check out https://cloud.r-project.org/web/packages/ipumsr/vignettes/ipums.html. This will show you how to create factor variables from the labels, etc.
